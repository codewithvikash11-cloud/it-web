                ...
                <div className={styles.grid}>
                    ...
                    <div className={styles.col}>
                        ...
                        <ul className={styles.list}>
                            ...
                            <li><Link href="#">Shopify Solutions</Link></li>
                            <li><Link href="#">Web & App Dev</Link></li>
                    ...
                    <div className={styles.col}>
                        <h4>Contact</h4>
                        <ul className={styles.list}>
                            <li><a href="mailto:hello@roviotech.com">hello@roviotech.com</a></li>
                            <li><a href="tel:+1234567890">+1 (234) 567-890</a></li>
                            <li>123 Tech Avenue,<br />Innovation City, 10101</li>
                        </ul>
                    </div>
                </div>

                <div className={styles.bottom}>
                    <p>&copy; {new Date().getFullYear()} Rovio Tech. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
